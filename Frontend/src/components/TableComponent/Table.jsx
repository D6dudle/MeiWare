...
import { HiChevronDoubleLeft, HiChevronLeft, HiChevronRight, HiChevronDoubleRight, HiPencilAlt } from "react-icons/hi";
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="ml-4">
        ...
        <div className="text-sm text-gray3">{row.original[column.emailAccessor]}</div>
      </div>
    </div>
  )
}
...
const tableHooks = (hooks) => {
  hooks.visibleColumns.push((columns) => [
    ...columns,
    {
      ...
      Header: "",
      Cell: ({ row }) => (
        <HiPencilAlt className='text-white' onClick={() => alert('Editing: ' + row.values.title)}
        />
      ),
    }
  ]);
        ...
        <div className="-my-2 overflow-x-auto -mx-4 sm:-mx-6 lg:-mx-8">
          <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              <table {...getTableProps()} className="min-w-full divide-y divide-gray4">
          ...
          <div>
            <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
              ...
              >
                ...
                <HiChevronDoubleLeft className="h-5 w-5 text-primary" aria-hidden="true" />
              </PageButton>
              <PageButton
              ...
              >
                ...
                <HiChevronLeft className="h-5 w-5 text-primary" aria-hidden="true" />
              </PageButton>
              <PageButton
                onClick={() => nextPage()}
                ...
                <HiChevronRight className="h-5 w-5 text-primary" aria-hidden="true" />
              </PageButton>
              <PageButton
              ...
              >
                ...
                <HiChevronDoubleRight className="h-5 w-5 text-primary" aria-hidden="true" />
              </PageButton>
            </nav>
          </div>
        </div>
